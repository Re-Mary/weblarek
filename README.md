...
```
{
payment: 'Не выбран спасоб оплаты',
email: 'Укажите email',
}
```
...
### Слой коммуникации
В этом слое описывается взаимодействовие с другими приложениями. Для связи приложения с сервером используется отдельный класс, который инкапсулирует работу с API. Он работает поверх класса Api и использует его методы get и post.
